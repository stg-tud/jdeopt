...
public class ObjectStreamField
     ...
     * field are serialized and deserialized in the default manner--if the field
     * is non-primitive, object values are serialized and deserialized as if
     * they had been written and read by calls to writeObject and readObject. If
     * unshared is true, values of the represented field are serialized and
     * deserialized as if they had been written and read by calls to
     * writeUnshared and readUnshared.
     *
     * @param name field name
     * @param type field type
     * @param unshared if false, write/read field values in the same manner as
     * writeObject/readObject; if true, write/read in the same manner as
     ...
     * ObjectStreamField (if non-primitive) will return Object.class (as opposed
    ...
    /**
     * Compare this field with another <code>ObjectStreamField</code>. Return -1
     * if this is smaller, 0 if equal, 1 if greater. Types that are primitives
     * are "smaller" than object types. If equal, the field names are compared.
     */
    // REMIND: deprecate?
