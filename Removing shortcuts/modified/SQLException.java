...
public class SQLException extends java.lang.Exception
    ...
    /**
     * Constructs a <code>SQLException</code> object. The <code>reason</code>,
     * <code>SQLState</code> are initialized to <code>null</code> and the vendor
    ...
    /**
     * Constructs a <code>SQLException</code> object with a given
     * <code>reason</code>, <code>SQLState</code> and  <code>cause</code>. The
     ...
     * by setNextException(SQLException ex).
     *
    ...
    /**
     * Returns an iterator over the chained SQLExceptions. The iterator will be
     * used to iterate over each SQLException and its underlying cause (if any).
     *
     * @return an iterator over the chained SQLExceptions and causes in the
     * proper order
     *
     * @since 1.6
     */
    ...
    private static final AtomicReferenceFieldUpdater<SQLException, SQLException> nextUpdater
            = x_newUpdater(SQLException.class, SQLException.class, "next");
