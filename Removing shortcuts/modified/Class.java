...
// This file was modified by Philipp Holzinger, Fraunhofer SIT, philipp.holzinger@sit.fraunhofer.de 
 ...
 * void) using a class literal. See Section 15.8.2 of
 * <cite>The Java&trade; Language Specification</cite>. For example:
 *
 * <blockquote>
 * {@code System.out.println("The name of class Foo is: "+Foo.class.getName());}
 * </blockquote>
 *
 * @param <T> the type of the class modeled by this {@code Class} object. For
...
public final class Class<T> implements java.io.Serializable,
     ...
     * illegal on the originating source code may be present.
     *
     ...
     * @param initialize if {@code true} the class will be initialized. See
     * Section 12.4 of <em>The Java Language Specification</em>.
     ...
     * otherwise be performed by the compiler. The {@link
     * java.lang.reflect.Constructor#newInstance(java.lang.Object...)
     * Constructor.newInstance} method avoids this problem by wrapping any
     * exception thrown by the constructor in a (checked) {@link
     ...
     * not accessible.
     * @throws InstantiationException if this {@code Class} represents an
     ...
     * loader for the current class and invocation of {@link SecurityManager#checkPackageAccess
    ...
    public ClassLoader getClassLoader() {
        ...
        ClassLoader.x_checkClassLoaderPermission();
        return cl;
    }
     ...
     * signature of this generic declaration does not conform to the format
     * specified in
     ...
     * created if it had not been created before. See the declaration of {@link
     * java.lang.reflect.ParameterizedType ParameterizedType} for the semantics
     * of the creation process for parameterized types. If this {@code Class}
     * represents either the {@code Object} class, an interface, a primitive
     * type, or void, then null is returned. If this object represents an array
     * class then the {@code Class} object representing the {@code Object} class
     * is returned.
     *
     * @throws java.lang.reflect.GenericSignatureFormatError if the generic
     ...
     * </blockquote>
     * suppose the value of {@code s} is an instance of {@code Shimmer}; the
     * value of the expression:
     * <blockquote> {@code s.getClass().getInterfaces()[0]}
     * </blockquote>
     * is the {@code Class} object that represents interface {@code FloorWax};
     * and the value of:
     * <blockquote> {@code s.getClass().getInterfaces()[1]}
     * </blockquote>
     ...
     * the generic superinterfaces refer to a parameterized type that cannot be
     * instantiated for any reason
     * @return an array of interfaces implemented by this class
     * @since 1.5
     */
     ...
     * a method, returns a {@link
     * java.lang.reflect.Method Method} object representing the immediately
     * enclosing method of the underlying class. Returns {@code null} otherwise.
     *
     ...
     * <ul>
     *
     * <li> the caller's class loader is not the same as the class loader of the
     * enclosing class and invocation of null null null null null null null null
     * null null null null null null null null null null null null null null
     * null null null null null null null null     {@link SecurityManager#checkPermission
     *         s.checkPermission} method with
     * {@code RuntimePermission("accessDeclaredMembers")} denies access to the
     * methods within the enclosing class
     *
     * <li> the caller's class loader is not the same as or an ancestor of the
     * class loader for the enclosing class and invocation of {@link SecurityManager#checkPackageAccess
     *         s.checkPackageAccess()} denies access to the package of the enclosing
     * class
     *
     * </ul>
     * @since 1.5
    ...
    public Method getEnclosingMethod() throws SecurityException {
        ...
        if (enclosingInfo == null) {
            ...
            enclosingCandidate.x_checkMemberAccess(Member.DECLARED, true);
            /*
    ...
    /**
     * If this {@code Class} object represents a local or anonymous class within
     * a constructor, returns a {@link
     * java.lang.reflect.Constructor Constructor} object representing the
     * immediately enclosing constructor of the underlying class. Returns
     * {@code null} otherwise. In particular, this method returns {@code null}
     * if the underlying class is a local or anonymous class immediately
     * enclosed by a type declaration, instance initializer or static
     * initializer.
     *
     ...
     *         s.checkPermission} method with
     * {@code RuntimePermission("accessDeclaredMembers")} denies access to the
     * constructors within the enclosing class
     *
     * <li> the caller's class loader is not the same as or an ancestor of the
     * class loader for the enclosing class and invocation of {@link SecurityManager#checkPackageAccess
     *         s.checkPackageAccess()} denies access to the package of the enclosing
     ...
     *         SecurityManager#checkPackageAccess s.checkPackageAccess()} denies access
    ...
    public Class<?> getDeclaringClass() throws SecurityException {
        ...
        if (candidate != null) {
            candidate.x_checkPackageAccess(true);
        }
        return candidate;
    }
     ...
     * @exception SecurityException If a security manager, <i>s</i>, is present
     * and the caller's class loader is not the same as or an ancestor of the
     * class loader for the enclosing class and invocation of {@link
     *             SecurityManager#checkPackageAccess s.checkPackageAccess()} denies access
    ...
    public Class<?> getEnclosingClass() throws SecurityException {
        ...
        if (enclosingCandidate != null) {
            enclosingCandidate.x_checkPackageAccess(true);
        }
    ...
    public Class<?>[] getClasses() {
        x_checkMemberAccess(Member.PUBLIC, false);
    ...
    public Field[] getFields() throws SecurityException {
        x_checkMemberAccess(Member.PUBLIC, true);
     ...
     * {@code Object}. Therefore, if no methods are explicitly declared in this
     ...
     * <LI> If C is the class {@code Object}, or if C is an interface, then the
     * superinterfaces of C (if any) are searched for a matching method. If any
     * such method is found, it is reflected.</LI>
     * </OL></LI>
     * </OL>
     *
     * <p>
     ...
     * formal parameter types, that is the method reflected. If more than one
     ...
     * can be implemented with {@linkplain
     * java.lang.reflect.Method#isBridge bridge methods}; the bridge method and
     * the method being overridden would have the same signature but different
     * return types.
     *
     * <p>
     * If this {@code Class} object represents an array type, then this method
     ...
     * this class and invocation of null null null null null null null null null
     * null null null null null null null null null null null null null null
     * null null null null null null null     {@link SecurityManager#checkPermission
     *         s.checkPermission} method with
     * {@code RuntimePermission("accessDeclaredMembers")} denies access to the
    ...
    public Class<?>[] getDeclaredClasses() throws SecurityException {
        x_checkMemberAccess(Member.DECLARED, false);
    ...
    public Field[] getDeclaredFields() throws SecurityException {
        x_checkMemberAccess(Member.DECLARED, true);
     ...
     * class loader, the method delegates to {@link
     ...
     *
     * <blockquote> {@code modified_package_name/name}
     * </blockquote>
     *
     * <p>
     ...
     *
     * @throws SecurityException if a security manager exists and its
     * {@code checkPermission} method doesn't allow getting the
     * ProtectionDomain.
     *
    ...
    private void x_checkMemberAccess(int which, boolean checkProxyInterfaces) {
        final SecurityManager s = System.getSecurityManager();
        if (s != null) {
            if (which != Member.PUBLIC) {
                s.checkPermission(SecurityConstants.CHECK_MEMBER_ACCESS_PERMISSION);
        ...
        this.x_checkPackageAccess(checkProxyInterfaces);
    }
    ...
    private void x_checkPackageAccess(boolean checkProxyInterfaces) {
        final SecurityManager s = System.getSecurityManager();
        if (s != null) {
            String name = this.getName();
            int i = name.lastIndexOf('.');
            ...
            if (checkProxyInterfaces && Proxy.isProxyClass(this)) {
                ReflectUtil.x_checkProxyPackageAccess(this.getInterfaces());
            }
        }
    }
     ...
     * </pre> A new handle is generated for the initial time the class
     * descriptor is written into the stream. Future references to the class
     * descriptor are written as references to the initial class descriptor
     * instance.
     *
    ...
    private static ReflectionFactory getReflectionFactory() {
        if (reflectionFactory == null) {
            reflectionFactory
                    = java.security.AccessController.doPrivileged(new sun.reflect.ReflectionFactory.GetReflectionFactoryAction());
        }
     ...
     * represent a subclass of the specified class (here "subclass" includes the
     * class itself).
     * @since 1.5
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns an {@code AnnotatedType} object that represents the use of a type
    ...
    public static class X_GetDeclaredFieldAction implements PrivilegedExceptionAction<Field> {

        private Class klass;
        private String fieldName;

        public X_GetDeclaredFieldAction(Class klass, String fieldName) {
            this.klass = klass;
    ...
    public static class X_GetEnclosingMethodAction implements PrivilegedExceptionAction<Method> {

        private Class klass;

        public X_GetEnclosingMethodAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_GetEnclosingConstructorAction implements PrivilegedExceptionAction<Constructor> {

        public Class klass;

        public X_GetEnclosingConstructorAction(Class klass) {
            this.klass = klass;
        }

        @Override
        public Constructor run() throws SecurityException {
            return klass.getEnclosingConstructor();
        }
    }

    public static class X_GetDeclaringClassAction implements PrivilegedExceptionAction<Class> {

        public Class klass;

        public X_GetDeclaringClassAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_GetEnclosingClassAction implements PrivilegedExceptionAction<Class> {

        public Class klass;

        public X_GetEnclosingClassAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_GetFieldsAction implements PrivilegedExceptionAction<Field[]> {

        public Class klass;

        public X_GetFieldsAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_GetMethodsAction implements PrivilegedExceptionAction<Method[]> {

        public Class klass;

        public X_GetMethodsAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_GetConstructorsAction implements PrivilegedExceptionAction<Constructor[]> {

        public Class klass;

        public X_GetConstructorsAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_GetFieldAction implements PrivilegedExceptionAction<Field> {

        private Class klass;
        private String fieldName;

        public X_GetFieldAction(Class klass, String fieldName) {
            this.klass = klass;
            this.fieldName = fieldName;
        }
    ...
    public static class X_GetMethodAction implements PrivilegedExceptionAction<Method> {

        private Class klass;
        private String methodName;
        private Class[] params;

        public X_GetMethodAction(Class klass, String methodName, Class[] params) {
            this.klass = klass;
    ...
    public static class X_GetConstructorAction implements PrivilegedExceptionAction<Constructor> {

        private Class klass;
        private Class[] params;

        public X_GetConstructorAction(Class klass, Class[] params) {
            this.klass = klass;
            this.params = params;
        }
    ...
    public static class X_GetDeclaredClassesAction implements PrivilegedExceptionAction<Class[]> {

        private Class klass;

        public X_GetDeclaredClassesAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_GetDeclaredFieldsAction implements PrivilegedExceptionAction<Field[]> {

        private Class klass;

        public X_GetDeclaredFieldsAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_GetDeclaredMethodsAction implements PrivilegedExceptionAction<Method[]> {

        private Class klass;

        public X_GetDeclaredMethodsAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_GetDeclaredConstructorsAction implements PrivilegedExceptionAction<Constructor[]> {

        private Class klass;

        public X_GetDeclaredConstructorsAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_GetDeclaredMethodAction implements PrivilegedExceptionAction<Method> {

        private Class klass;
        private String methodName;
        private Class[] params;

        public X_GetDeclaredMethodAction(Class klass, String methodName, Class[] params) {
            this.klass = klass;
            this.methodName = methodName;
            this.params = params;
        }
    ...
    public static class X_GetDeclaredConstructorAction implements PrivilegedExceptionAction<Constructor> {

        private Class klass;
        private Class[] params;

        public X_GetDeclaredConstructorAction(Class klass, Class[] params) {
            this.klass = klass;
            this.params = params;
        }
        ...
        @Override
        public Constructor run() throws NoSuchMethodException, SecurityException {
            return klass.getDeclaredConstructor(params);
        }
    }

    public static class X_NewInstanceAction implements PrivilegedExceptionAction<Object> {

        private Class klass;

        public X_NewInstanceAction(Class klass) {
            this.klass = klass;
        }

        @Override
        public Object run() throws InstantiationException, IllegalAccessException, SecurityException {
            return klass.newInstance();
        }
    }

    public static class X_GetClassLoaderAction implements PrivilegedExceptionAction<ClassLoader> {

        private Class klass;

        public X_GetClassLoaderAction(Class klass) {
            this.klass = klass;
        }
    ...
    public static class X_ForNameAction implements PrivilegedExceptionAction<Class> {

        private String name;
        private boolean initialize;
        private ClassLoader loader;

        public X_ForNameAction(String name, boolean initialize, ClassLoader loader) {
            this.name = name;
        ...
        @Override
        public Class run() throws SecurityException, ClassNotFoundException {
            return Class.forName(name, initialize, loader);
        }
    }

    public static class X_GetTypeAction implements PrivilegedExceptionAction<Class> {

        private ObjectStreamField obj;

        public X_GetTypeAction(ObjectStreamField obj) {
            this.obj = obj;
        }
    ...
    public static class X_GetParentAction implements PrivilegedExceptionAction<ClassLoader> {

        private ClassLoader cl;

        public X_GetParentAction(ClassLoader cl) {
            this.cl = cl;
        }
    ...
    public static class X_GetSystemClassLoaderAction implements PrivilegedExceptionAction<ClassLoader> {
    ...
    public static class X_ForClassAction implements PrivilegedExceptionAction<Class> {

        private java.io.ObjectStreamClass obj;

        public X_ForClassAction(java.io.ObjectStreamClass obj) {
            this.obj = obj;
        }
    ...
    public static class X_GetContextClassLoaderAction implements PrivilegedExceptionAction<ClassLoader> {

        private Thread obj;

        public X_GetContextClassLoaderAction(Thread obj) {
            this.obj = obj;
        }

        @Override
        public ClassLoader run() throws SecurityException {
            return obj.getContextClassLoader();
        }
    }

    public static class X_GetProxyClassAction implements PrivilegedExceptionAction<Class> {

        private ClassLoader loader;
        private Class<?>[] interfaces;

        public X_GetProxyClassAction(ClassLoader loader, Class<?>... interfaces) {
            this.loader = loader;
            this.interfaces = interfaces;
        }

        @Override
        public Class run() throws IllegalArgumentException, NullPointerException, SecurityException {
            return Proxy.getProxyClass(loader, interfaces);
        }
    }

    public static class X_NewProxyInstanceAction implements PrivilegedExceptionAction<Object> {

        private ClassLoader loader;
        private Class<?>[] interfaces;
        private java.lang.reflect.InvocationHandler h;

        public X_NewProxyInstanceAction(ClassLoader loader, Class<?>[] interfaces, java.lang.reflect.InvocationHandler h) {
            this.loader = loader;
            this.interfaces = interfaces;
            this.h = h;
        }
        ...
        @Override
        public Object run() throws IllegalArgumentException, NullPointerException, SecurityException {
            return Proxy.newProxyInstance(loader, interfaces, h);
        }
    }

    public static class X_GetInvocationHandlerAction implements PrivilegedExceptionAction<java.lang.reflect.InvocationHandler> {

        private Object proxy;

        public X_GetInvocationHandlerAction(Object proxy) {
            this.proxy = proxy;
        }

        @Override
        public java.lang.reflect.InvocationHandler run() throws IllegalArgumentException, SecurityException {
