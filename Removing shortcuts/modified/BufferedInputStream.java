...
public class BufferedInputStream extends FilterInputStream {
    ...
    private static final AtomicReferenceFieldUpdater<BufferedInputStream, byte[]> bufUpdater
            = x_newUpdater(BufferedInputStream.class, byte[].class, "buf");
     ...
     * <code>buf.length</code>; elements <code>buf[0]</code> through <code>buf[count-1]
     ...
     * this field is <code>-1</code>. If there is a marked position in the input
     * stream, then <code>buf[markpos]</code> is the first byte to be supplied
     * as input after a <code>reset</code> operation. If <code>markpos</code> is
     * not <code>-1</code>, then all bytes from positions
     ...
     * input stream has been closed by invoking its {@link #close()} method, or
     * an I/O error occurs.
     */
     ...
     * has been invalidated, or the stream has been closed by invoking its
