 ...
 */
public class GetDeclaredConstructorsProcessor extends ClassProcessor {

    @Override
    protected String getRedirectMethodName() {
        return "x_getDeclaredConstructors";
    }
    ...
    protected String getPrivilegedExceptionActionName() {
        return "java.lang.Class.X_GetDeclaredConstructorsAction";
    }
    ...
    public boolean isPatchClass(String className) {
        if (className.equals("java.lang.Class$X_GetDeclaredConstructorsAction")) {
            return true;
        }
        return false;
    }
